...
def main() -> None:
	...
	tf_parser = subparsers.add_parser("tf", help="return count of token in doc")
	tf_parser.add_argument("doc_id", type=int, help="Document ID")
	tf_parser.add_argument("term", type=str, help="untokenized search term")
	...
	match args.command:
		...
		case "tf":
			...
			print(f"term freq of {args.term} in {args.doc_id}: {term_freq}")
		...
		case "bm25search":
			print("starting search for", args.query)
			bm25_list = bm25_search_command(args.query)
			for i, res in enumerate(bm25_list, 1):
